class Users::PortfoliosController < ApplicationController
  ...
  def update
    ...
    if(portfolio.update(portfolio_params))
      ...
      render component: 'PortfolioEdit', props: { user: current_user, portfolio: current_user.portfolio, slug: current_user.slug, avatar: current_user.portfolio.avatar.url, locations: Location.distinct_city_states, userLocations: current_user.portfolio.locations }, status: 400
    end
  end
