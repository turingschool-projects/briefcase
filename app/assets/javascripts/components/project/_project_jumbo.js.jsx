var ProjectJumbo = React.createClass({
  render: function() {
    return (
      <div>
          <section id="block-block-96" className="block block-block block-background block-block-96 block-layout-contained      clearfix" >
              ...
              <div className="block-content-container">
                <div className="block-content-holder">
                  <div className="block-content">
                    ...
                    <span><hr/></span>
                    <p>Use the form below to add a new project to your profile</p>
                  </div>
