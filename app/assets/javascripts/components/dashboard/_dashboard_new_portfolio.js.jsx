            ...
            <div className="card-content">
              ...
              <center>
                <div className='col s12 project-default-buttons'>
  	              <ul>
  	                <li><a href={"/alumni/" + user.slug + "/portfolio/new"}><button className='btn transparent repository-btn'>Create Profile <i className="fa fa-long-arrow-right" aria-hidden="true"></i></button></a></li>
  	              </ul>
                </div>
              </center>
            </div>
