        ...
        <div className='row'>
          ...
          <div className='col s12 l6 search-buttons'>
            <ul>
              ...
              <li><button className='title btn transparent heart' onClick={this.showHearts} aria-label="favorite graduates"><i id="by-heart" className="fa fa-heart-o center fa-2x" aria-label="favorite graduates" aria-hidden="true"></i></button></li>
