      ...
      <div>
        <form>
          ...
          <div className="container">
            <button id='portfolio-edit-submit' className="btn waves-effect waves-light portfolio-btns" type="submit" name="action" value="Save Profile" onClick={this.handleUpdate}>Save Profile</button>
          </div>
        </form>
      </div>
    );
